...
<span id="typesystemvariables"></span><h1>Type System Variables</h1>
...
<p id="arg-number"><strong>%&lt;number&gt;</strong></p>
<blockquote>
<div><p>Replaced by the name of a C++ argument in the position indicated by <code class="docutils literal notranslate"><span class="pre">&lt;number&gt;</span></code>.
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">void</span> <span class="nf">argRemoval</span><span class="p">(</span><span class="kt">int</span> <span class="n">a0</span><span class="p">,</span> <span class="kt">int</span> <span class="n">a1</span> <span class="o">=</span> <span class="mi">123</span><span class="p">);</span>
</pre></div>
</div>
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">void</span> <span class="nf">argRemoval</span><span class="p">(</span><span class="kt">int</span> <span class="n">a0</span><span class="p">,</span> <span class="n">Point</span> <span class="n">a1</span> <span class="o">=</span> <span class="n">Point</span><span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">),</span> <span class="kt">bool</span> <span class="n">a2</span> <span class="o">=</span> <span class="nb">true</span><span class="p">,</span> <span class="n">Point</span> <span class="n">a3</span> <span class="o">=</span> <span class="n">Point</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">),</span> <span class="kt">int</span> <span class="n">a4</span> <span class="o">=</span> <span class="mi">56</span><span class="p">);</span>
</pre></div>
</div>
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="o">%</span><span class="mi">1</span><span class="p">,</span> <span class="n">Point</span><span class="p">(</span><span class="mi">6</span><span class="p">,</span> <span class="mi">9</span><span class="p">),</span> <span class="o">%</span><span class="mi">3</span><span class="p">,</span> <span class="n">Point</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">),</span> <span class="o">%</span><span class="mi">5</span>
</pre></div>
</div>
</div></blockquote>
</div></blockquote>
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">double</span> <span class="n">value</span> <span class="o">=</span> <span class="o">%</span><span class="n">CONVERTTOCPP</span><span class="p">[</span><span class="kt">double</span><span class="p">](</span><span class="n">pyValue</span><span class="p">);</span>
</pre></div>
</div>
</div></blockquote>
<p>Pointer assignments are also possible:</p>
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">void</span> <span class="nf">f</span><span class="p">(</span><span class="kt">double</span> <span class="o">*</span><span class="n">valuePtr</span><span class="p">)</span>
<span class="p">{</span>
    <span class="o">*</span><span class="n">valuePtr</span> <span class="o">=</span> <span class="o">%</span><span class="n">CONVERTTOCPP</span><span class="p">[</span><span class="kt">double</span><span class="p">](</span><span class="n">pyValue</span><span class="p">);</span>
</pre></div>
</div>
</div></blockquote>
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">double</span> <span class="o">*</span> <span class="n">valuePtr</span> <span class="o">=</span> <span class="o">%</span><span class="n">CONVERTTOCPP</span><span class="p">[</span><span class="kt">double</span><span class="p">](</span><span class="n">pyValue</span><span class="p">);</span>
</pre></div>
</div>
</div></blockquote>
...
<p id="pyarg"><strong>%PYARG_&lt;number&gt;</strong></p>
<blockquote>
<div><p>Similar to <code class="docutils literal notranslate"><span class="pre">%&lt;number&gt;</span></code>, but is replaced by the Python arguments (PyObjects)
received by the Python wrapper method.</p>
<p>If used in the context of a native code injection, i.e. in a virtual method
override, <code class="docutils literal notranslate"><span class="pre">%PYARG_&lt;number&gt;</span></code> will be translated to one item of the Python tuple
holding the arguments that should be passed to the Python override for this
virtual method.</p>
<p>The example</p>
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">long</span> <span class="n">a</span> <span class="o">=</span> <span class="n">PyInt_AS_LONG</span><span class="p">(</span><span class="o">%</span><span class="n">PYARG_1</span><span class="p">);</span>
</pre></div>
</div>
</div></blockquote>
<p>is equivalent of</p>
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">long</span> <span class="n">a</span> <span class="o">=</span> <span class="n">PyInt_AS_LONG</span><span class="p">(</span><span class="n">PyTuple_GET_ITEM</span><span class="p">(</span><span class="o">%</span><span class="n">PYTHON_ARGUMENTS</span><span class="p">,</span> <span class="mi">0</span><span class="p">));</span>
</pre></div>
</div>
</div></blockquote>
...
<p>This example</p>
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="n">Py_DECREF</span><span class="p">(</span><span class="o">%</span><span class="n">PYARG_1</span><span class="p">);</span>
...
<p>is equivalent of</p>
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="n">Py_DECREF</span><span class="p">(</span><span class="n">PyTuple_GET_ITEM</span><span class="p">(</span><span class="o">%</span><span class="n">PYTHON_ARGUMENTS</span><span class="p">,</span> <span class="mi">0</span><span class="p">));</span>
