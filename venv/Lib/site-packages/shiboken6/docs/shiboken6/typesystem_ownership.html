...
<div class="section" id="ownership-management-in-the-typesystem">
...
<div class="section" id="ownership-transfer-from-c-to-target">
...
<div class="section" id="ownership-transfer-from-target-to-c">
...
<div class="section" id="c-wrapper-code">
...
(see <a class="reference internal" href="typesystem_codegeneration.html#codegenerationterminology"><span class="std std-ref">Code Generation Terminology</span></a>).</p>
<div class="section" id="return-values-of-virtual-functions">
