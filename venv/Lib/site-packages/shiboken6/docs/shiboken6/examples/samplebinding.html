...
<div class="highlight-cpp notranslate"><div class="highlight"><pre><span></span> <span class="k">class</span> <span class="nc">Icecream</span>
 ...
 <span class="k">public</span><span class="o">:</span>
     ...
     <span class="k">virtual</span> <span class="n">Icecream</span> <span class="o">*</span><span class="nf">clone</span><span class="p">();</span>
     <span class="k">virtual</span> <span class="o">~</span><span class="n">Icecream</span><span class="p">();</span>
     <span class="k">virtual</span> <span class="k">const</span> <span class="n">std</span><span class="o">::</span><span class="n">string</span> <span class="nf">getFlavor</span><span class="p">();</span>
...
<code class="file docutils literal notranslate"><span class="pre">&lt;PYTHON_ENV_ROOT&gt;/site-packages/lib/PySide6/examples/samplebinding</span></code>.</p>
</div>
<dl class="simple">
