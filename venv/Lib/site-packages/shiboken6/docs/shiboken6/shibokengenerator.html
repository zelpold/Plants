...
<p>Creating new bindings involves creating several pieces of “code”: the header,
the typesystem and, in most cases, the injected code.</p>
<dl class="field-list simple">
<dt class="field-odd">header</dt>
<dd class="field-odd"><p>A header with <code class="docutils literal notranslate"><span class="pre">#include</span></code> directives listing all the headers of the
...
the command line option <code class="docutils literal notranslate"><span class="pre">--use-global-header</span></code> should be passed as
well to prevent the headers from being suppressed in the generated
code.</p>
</dd>
</dl>
<dl class="simple">
<dt>:<a class="reference internal" href="typesystem_specifying_types.html#typesystem"><span class="std std-ref">typesystem</span></a>: XML files that provides the developer with a tool to customize the</dt><dd><p>way that the generators will see the classes and functions. For
example, functions can be renamed, have its signature changed and
many other actions.</p>
</dd>
<dt>:<a class="reference internal" href="typesystem_codeinjection.html#codeinjectionsemantics"><span class="std std-ref">inject code</span></a>: allows the developer to insert</dt><dd><p>handwritten code where the generated code is not suitable or
needs some customization.</p>
</dd>
</dl>
...
<dt><code class="docutils literal notranslate"><span class="pre">--use-global-header</span></code></dt><dd><p>Use the global headers passed on the command line in generated code.</p>
</dd>
</dl>
...
<dl class="simple" id="clang-option">
<dt><code class="docutils literal notranslate"><span class="pre">--clang-option=&lt;option&gt;</span></code></dt><dd><p>Option to be passed to clang</p>
</dd>
</dl>
<dl class="simple" id="clang-options">
<dt><code class="docutils literal notranslate"><span class="pre">--clang-options=&lt;option1&gt;[,&lt;option2&gt;,...]&gt;</span></code></dt><dd><p>Options to be passed to clang.
When ‘-‘ is passed as the first option in the list, none of the options
built into shiboken will be added, allowing for a complete replacement.</p>
</dd>
</dl>
