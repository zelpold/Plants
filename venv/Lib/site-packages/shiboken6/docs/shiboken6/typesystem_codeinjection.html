...
<p>The following table describes the semantics of <a class="reference internal" href="typesystem_manipulating_objects.html#inject-code"><span class="std std-ref">inject-code</span></a> tag as used on
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">InjectCode</span>
<span class="p">{</span>
...
<p>There are a number of placeholders indicated by a percent sign <code class="docutils literal notranslate"><span class="pre">%</span></code>, which
will be expanded when inserting the code. For a list, see
<a class="reference internal" href="typesystem_variables.html#typesystemvariables"><span class="std std-ref">Type System Variables</span></a>.</p>
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="kt">int</span> <span class="nf">InjectCodeWrapper::virtualMethod</span><span class="p">(</span><span class="kt">int</span> <span class="n">arg</span><span class="p">)</span>
<span class="p">{</span>
...
<blockquote>
<div><div class="highlight-c++ notranslate"><div class="highlight"><pre><span></span><span class="k">static</span> <span class="n">PyObject</span> <span class="o">*</span><span class="nf">PyInjectCode_overloadedMethod</span><span class="p">(</span><span class="n">PyObject</span> <span class="o">*</span><span class="n">self</span><span class="p">,</span> <span class="n">PyObject</span> <span class="o">*</span><span class="n">arg</span><span class="p">)</span>
<span class="p">{</span>
    <span class="n">PyObject</span><span class="o">*</span> <span class="n">py_result</span><span class="p">{};</span>
    ...
    <span class="nl">PyInjectCode_overloadedMethod_TypeError</span><span class="p">:</span>
...
<span class="cp">#include</span> <span class="cpf">&lt;shiboken.h&gt;</span><span class="cp"></span>
<span class="p">(...)</span>
<span class="cp">#include</span> <span class="cpf">&quot;injectcode_wrapper.h&quot;</span><span class="cp"></span>
<span class="k">using</span> <span class="k">namespace</span> <span class="nn">Shiboken</span><span class="p">;</span>
...
<span class="n">init_injectcode</span><span class="p">(</span><span class="n">PyObject</span> <span class="o">*</span><span class="k">module</span><span class="p">)</span>
<span class="p">{</span>
    <span class="p">(...)</span>
<span class="p">}</span>
...
<span class="p">{</span>
    ...
    <span class="n">PyModule_AddObject</span><span class="p">(</span><span class="k">module</span><span class="p">,</span> <span class="s">&quot;InjectCode&quot;</span><span class="p">,</span>
...
<span class="p">{</span>
    ...
    <span class="n">PyObject</span> <span class="o">*</span><span class="k">module</span> <span class="o">=</span> <span class="n">Py_InitModule</span><span class="p">(</span><span class="s">&quot;MODULENAME&quot;</span><span class="p">,</span> <span class="n">MODULENAME_methods</span><span class="p">);</span>
